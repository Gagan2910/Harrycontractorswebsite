<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="viewservices.aspx.cs" Inherits="Harrycontractorswebsite.WebForm13" %>
        ...
        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" GroupItemCount="3" DataKeyNames="ServiceImage" style="margin-left: 0px" OnSelectedIndexChanged="ListView1_SelectedIndexChanged1">
            <AlternatingItemTemplate>
                <td runat="server" style="background-color: #FAFAD2;color: #284775;" >
                    <table style="text-align: center">
                        ...
                        <tr><td><asp:Image ID="ServiceImageLabel1" runat="server" Imageurl='<%# Eval("ServiceImage") %>'  width="300px" height="200px"/></td></tr>
                        <tr><td><h2><asp:Label ID="PriceLabel" runat="server" Text='<%# Eval("Price") %>' /></h2></td></tr>
                         <tr><td><asp:ImageButton ID="ImageButton2" onclick="ImageButton2_Click" runat="server" ImageUrl="~/images/addcart.png" /></td></tr>
            ...
            <ItemTemplate>
                <td runat="server" style="background-color: #FFFBD6;color: #333333;" >
                    <table style="text-align: center">
                        <tr><td style="width:300px"><h2><asp:Label ID="ServicenameLabel" runat="server" Text='<%# Eval("Servicename") %>' /></h2></td></tr>
                       <tr><td><asp:Image ID="ServiceImageLabel" runat="server" Imageurl='<%# Eval("ServiceImage") %>' width="300px" height="200px"  /></td></tr>
                        <tr><td><h2><asp:Label ID="PriceLabel" runat="server" Text='<%# Eval("Price") %>' /></h2></td></tr>
                        <tr><td><asp:ImageButton ID="ImageButton1" onclick="ImageButton1_Click" runat="server" ImageUrl="~/images/addcart.png" /></td></tr>
